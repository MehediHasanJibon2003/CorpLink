    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 dark:border-slate-700/80 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <a href="#features" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-blue-600">
            Features
          </a>
          <a href="#overview" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-blue-600">
            Overview
          </a>
          <a href="#contact" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-blue-600">
            Contact
          </a>
        </nav>
