    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] border-2 border-slate-100 dark:border-white/5 shadow-sm overflow-hidden">
        ...
        <div className="divide-y-2 divide-slate-50 dark:divide-white/5">
           {tasks.length === 0 ? (
             <div className="p-20 text-center text-slate-400 font-bold italic">No tasks found for this department.</div>
           ) : tasks.map(task => (
             <div key={task.id} className="p-8 hover:bg-slate-50 dark:hover:bg-white/5 transition-all group">
