  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {teams.length === 0 ? (
          <div className="col-span-full py-20 text-center bg-white dark:bg-white/5 rounded-[2.5rem] border-2 border-dashed border-slate-200">
             <p className="text-slate-400 font-black uppercase tracking-widest">No teams established</p>
          </div>
        ) : teams.map(team => (
          <div key={team.id} className="group bg-white dark:bg-slate-800 rounded-[2rem] border-2 border-slate-100 dark:border-white/5 p-8 shadow-sm hover:border-blue-500/30 transition-all flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                 <div className="bg-blue-50 dark:bg-blue-600/10 p-4 rounded-2xl">
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Operational Lead</label>
              <select 
                value={team.lead_id || ""}
