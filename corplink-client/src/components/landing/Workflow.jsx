    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        >
          ...
          >
            Enterprise Velocity. <br className="hidden md:block" /> <span className="text-orange-500">Simplified Deployment.</span>
          </motion.h2>
          <p
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 md:gap-16 w-full">
          {steps.map((step, idx) => (
            <motion.div 
              key={idx} 
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center z-10 px-4 md:px-0">
                <div className="w-16 h-16 md:w-24 md:h-24 rounded-2xl md:rounded-[2rem] bg-orange-500/10 flex items-center justify-center border border-orange-500/20 mb-6 md:mb-8 shadow-2xl shadow-orange-500/5 group-hover:scale-110 group-hover:bg-orange-500 group-hover:text-white transition-all duration-500">
                  <span className="font-black text-heading-2 md:text-heading-1 text-orange-500 group-hover:text-white">
                    0{idx + 1}
                  </span>
                </div>
