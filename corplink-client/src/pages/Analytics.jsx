    ...
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          return (
            <div
              key={i}
              className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-5 flex items-start justify-between"
            >
              <div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-lg">
          The full advanced analytics dashboard is currently under construction.
          Future updates will bring predictive performance analysis and
          automated reporting generated from your workspace data.
        </p>
      </div>
    </AppLayout>
  );
