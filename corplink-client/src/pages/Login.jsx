...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Building2, BarChart3, Users, CheckCircle, Zap } from "lucide-react"

const FEATURES = [
  { icon: Building2, title: "Enterprise Management", desc: "Full control over departments, teams & roles" },
  { icon: Users, title: "Workforce Collaboration", desc: "Connect employees across the entire organization" },
  { icon: BarChart3, title: "Real-time Analytics", desc: "Track performance and productivity at a glance" },
  { icon: Zap, title: "Instant Sync", desc: "Live updates across all devices and users" },
]
      ...
      try {
        ...
        if (userProfile?.company_id) {
          await supabase.from("activity_logs").insert([{
            company_id: userProfile.company_id, user_id: data.user.id,
            action: "System Login", entity: "auth", severity: "info", status: "success"
          }])
        }
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <Link to="/" className="flex items-center gap-3 w-fit">
            <div className="w-11 h-11 rounded-xl bg-orange-500 flex items-center justify-center font-black text-white text-xl shadow-lg shadow-orange-500/30">C</div>
        ...
        <div className="relative z-10 my-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-white/80 text-sm font-medium">Enterprise Platform</span>
          </div>
            ...
            {FEATURES.map((f, i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600/30 transition">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white dark:bg-slate-950">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400">Sign in to your corporate workspace</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-slate-400 pointer-events-none" style={{width:'18px',height:'18px'}} />
                <input
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" style={{width:'18px',height:'18px'}} />
                <input
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white dark:bg-slate-950 px-3 text-xs text-slate-400 font-medium">New to CorpLink?</span>
            </div>
          </div>
